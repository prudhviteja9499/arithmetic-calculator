...
public class  virtualkey{
	...
	public static void main(String[] args) {
		...
		System.out.println("---------------------------------------");
		System.out.println("Name        : n.prudhviteja");
		System.out.println("Email       : prudhviteja9499@company.com");
		...
		lp : while(true)
		{
			...
			case 1: File file = new File("C:\\Users\\REAPER KILLER\\eclipse-workspace\\phase1project");
					...
					ip : while(true)
					{
						...
						case 1 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 ...
									 File fe = new File("C:\\Users\\REAPER KILLER\\eclipse-workspace\\phase1project"+name);
									 if(fe.exists())
									 {
									 ...
									 {
										 FileWriter fw = new FileWriter("C:\\Users\\REAPER KILLER\\eclipse-workspace\\phase1project"+name);
						...
						case 2 : System.out.println("\n---------------------------------------");
								 ...
								 File fd = new File("C:\\Users\\REAPER KILLER\\eclipse-workspace\\phase1project"+deletename);
								 if(fd.exists())
								 {
									 if(fd.delete())
								        {
						...
						case 3 : System.out.println("\n---------------------------------------");
								 ...
								 try
								 {
									 File filesearch = new File("C:\\Users\\REAPER KILLER\\eclipse-workspace\\phase1project");
